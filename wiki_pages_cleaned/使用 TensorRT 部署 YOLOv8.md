...
[TABLE COMPRESSED]
Columns: 键 值 描述 | imgsz 640 图像大小，可以是标量或 (h, w) 列表，例如 (640, 480) | half False FP16 量化 | dynamic False 动态轴 | simplify False 简化模型 | workspace 4 工作空间大小（GB）
