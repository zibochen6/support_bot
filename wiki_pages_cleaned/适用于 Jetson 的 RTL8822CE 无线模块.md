...
[TABLE COMPRESSED]
Columns: 芯片组 **TRL8822CE-CG** | WLAN 标准 IEEE802.11a/b/g/n/ac | 蓝牙规格 Bluetooth Core Specification v5.0/4.2/2.1 | 主机接口 PCI Express 2.1 for WLAN & USB2.0 FS for Bluetooth | 天线 通过 MHF4 连接器连接外部天线 | 尺寸 M.2 30*22*2.15mm (L*W*H) | 电源供应 DC 3.3V±0.2V@ 1000mA(Max) | 工作温度 -20℃ to +70℃ | 工作湿度 10% to 95% RH (Non-Condensing)
