...
[TABLE COMPRESSED]
Columns: 模型名称 精度 推理尺寸 推理时间 (ms) FPS | YOLOv5s FP32 320x320 16.66 60 | FP32 640x640 33.33 30 | INT8 640x640 16.66 60 | YOLOv5n FP32 640x640 16.66 60
...
[TABLE COMPRESSED]
Columns: 数据集 训练样本数量 本地PC训练时间（GTX 1660 Super） Google Colab训练时间（NVIDIA Tesla K80） | 自定义 542 2.2小时 1.3小时 | 240 1小时 42分钟 | Pascal VOC 2012 17112 83小时 15小时 | Microsoft COCO 2017 121408 750小时 125小时
