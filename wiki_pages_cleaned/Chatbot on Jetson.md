...
[TABLE COMPRESSED]
Columns: Model Parameters Size Command | Llama 3.2 3B 2.0 GB `ollama run llama3.2` | Llama 3.2 1B 1.3 GB `ollama run llama3.2:1b` | Llama 3.2 Vision 11B 7.9 GB `ollama run llama3.2-vision` | Phi 3 Mini 3.8B 2.3 GB `ollama run phi3` | Gemma 2 9B 5.5 GB `ollama run gemma2` | Mistral 7B 4.1 GB `ollama run mistral`
