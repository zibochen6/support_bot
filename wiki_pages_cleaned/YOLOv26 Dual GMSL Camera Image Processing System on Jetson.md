...
[TABLE COMPRESSED]
Columns: Parameter Value Note | **Camera Model** SG3S-ISX031C-GMSL2F Sensing GMSL2 Camera | **Capture Resolution** **1920 x 1536** Full Sensor Resolution | **Capture FPS** **30 FPS** Native Frame Rate | **Process Resolution** 640 x 480 Downscaled via Hardware (VIC) for Inference | **Pixel Format** YUY2 Converted to BGR via Hardware
