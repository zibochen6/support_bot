...
[TABLE COMPRESSED]
Columns: 标记 名称 备注 | DCIN(Type-C 接口) 仅供电 | HDMI | 1x USB 3.0 Type-A 端口 | 2x USB 2.0 Type-A 端口 | LAN | USB Type-C 端口 仅传输数据
...
[TABLE COMPRESSED]
Columns: 标记 名称 说明 | DCIN（圆形接口） 仅供电 | DP | HDMI | 4x USB 3.0 Type-A 端口 | LAN | Micro-B 端口 仅传输数据
