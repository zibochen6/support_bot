...
[TABLE COMPRESSED]
Columns: 状态 注释 | Image 1 SLEW= Vcc 此 RS232/RS422/RS485 多协议收发器限制通信速率如下： RS-232：最大数据速率为 1.5Mbps RS-485/RS-422：最大数据速率为 10Mbps 实际最大数据速率取决于所使用的 Jetson SO M | Image 0 SLEW = GND RS-232：最大数据速率为 250Kbps RS-485/RS-422：最大数据速率为 250kbps
