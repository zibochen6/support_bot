...
* * [NVIDIAÂ® Jetsonâ„¢](/NVIDIA_Jetson/)* FAQs* Create Backup and Restore on reComputer
...
## Backing Up the System[â€‹](#backing-up-the-system "Direct link to Backing Up the System")
...
## Restoring the System[â€‹](#restoring-the-system "Direct link to Restoring the System")
