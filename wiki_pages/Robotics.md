...
📦Hardware Wiki🎓Learning CenterNew

[📦Robot Kits](#robot-kits)[⚙️Joint Actuators](#actuators)[👁️Sensors](#sensors)[💻Software](#software)
...
[Lekiwi Mobile Base](/lerobot_lekiwi/)[Lekiwi Sound Follow](/sound_follow_robot/)

### 🦾 StarAI Arm

[StarAI Robotic ArmNew](/lerobot_starai_arm/)[StarAI Arm MoveIt 2New](/starai_arm_ros_moveit/)[StarAI with NVIDIA GR00T](/control_robotic_arm_via_gr00t)

### 🦿Legged Wheel

[Mini Wheeled-Legged RobotNew](/StackForce_Mini_Wheeled_Legged_Robot)

### 🖐️ Hand

[AmazingHandNew](/hand_amazinghand/)

### 🦀 End Effectors

[DM GripperNew](/dm_gripper/)

## ⚙️ Actuators

[MyActuator X Series](/myactuator_series/)[Damiao DM43 Series](/damiao_series/)[Feetech STS3215 Servo](/feetech_servo/)[HighTorque Series](/hightorque_control)[Fashionstar Series](/fashionstar_servo/)[Stackforce Series](/stackforce_series/)[RobStride ControlNew](/robstride_control/)

## 👁️ Sensors

**📡 LiDAR**

[RoboSense](/robosense_lidar/)[MID360](/mid360/)[A-LOAM Algorithm](/a_loam/)[Slamtec Series](/slamtec/)

**📷 Camera**

[Orbbec Gemini 2](/orbbec_gemini2/)[Gemini 335Lg DepthNew](/orbbec_gemini_335lg)[Gemini 336 DepthNew](/orbbec_gemini336)[SENSING GMSL2](/sensing_gmsl_cameras)[RoboSense AC1New](/ac1)[Orbbec with ROS](/orbbec_depth_camera_on_ros/)[ORB-SLAM3 Gemini2](/orb_slam3_orbbec_gemini2/)[CSI Camera on Jetson](/csi_camera_on_ros/)[PyCuVSLAM](/pycuvslam_recomputer_robotics/)

**🎤 Voice**

[ReSpeaker Core v2.0](/ReSpeaker_Core_v2.0/)[ReSpeaker Mic Array v2.0](/ReSpeaker_Mic_Array_v2.0/)

**🧭 IMU**

[HEXFELLOW Y200](/hexfellow_y200/)[WHEELTEC IMU](/wheeltec_imu/)

## 💻 Software

**ROS Ecosystem**

[ROS 1 Installation](/installing_ros1/)[ROS 2 Installation](/install_ros2_humble/)[Isaac ROS Installation](/install_isaacros/)[Isaac ROS AprilTag](/isaac_ros_apriltag/)[Isaac ROS V-SLAM](/isaac_ros_visual_slam/)

**PX4**

[PX4 with Jetson](/control_px4_with_recomputer_jetson/)[Object Tracking (PX4)](/object_tracking_with_reComputer_jetson_and_pX4/)

**NVIDIA Isaac**

[Isaac Lab Installation](/install_isaaclab/)[SO Arm RL TrainingNew](/training_soarm101_policy_with_isaacLab/)[SO100 Arm Isaac SimNew](/simulate_soarm101_by_leisaac/)
...
### ROS 1 Basics: 8 Lectures

Learn About Nodes, Topics, Services, and Basics Learning

Learning](https://github.com/Seeed-Projects/AI_Robotics_Academy/blob/main/Seeed_ROS1_Turorial/2.English/1.%20ROS%20Basics%208%20lectures/README.md)[ROS 1

Beginner ⏱️ 8h

### ROS 1 Robot Simulation: 7 Lectures.

From modeling to autonomous navigation.

Learning](https://github.com/Seeed-Projects/AI_Robotics_Academy/blob/main/Seeed_ROS1_Turorial/2.English/2.%20ROS%20Robot%20Simulation%207%20Lectures/README.MD)[ROS 2

Intermediate ⏱️ 8h

### ROS 2 Humble Basics: 8 Lectures

Learn About Nodes, Topics, Services, and Basics Learning

Learning](https://github.com/Seeed-Projects/AI_Robotics_Academy/blob/main/Seeed_ROS2_Tutorial/2.English/1.%20ROS%20Basics%208%20lectures/README.MD)MoveIt 1/2

Arm Beginner ⏱️ 6h

### MoveIt 1/2

Import a Custom Manipulator into MoveIt 1/2 and Implement Forward and Inverse Kinematics

PlanningPinocchio

Arm Intermediate ⏱️ 6h

### Pinocchio

Learn the Pinocchio Robotics Framework and Develop Kinematics and Dynamics Tasks for Your Own Manipulator
...
Sim2Real workflows, USD pipelines, and environment creation.
...
Model dynamics and simulation for agile robot control.
...
PPO, DRL training pipelines, and deployment to Jetson.
...
### Small Servo Humanoid Robots Course

Hardware Driving, Motion & Dance Choreography, and Secondary Development for Small Humanoid Robots.

PlanningMobile Robot

Beginner ⏱️ 6h

### Mobile Robotics (Lekiwi)

SLAM, Navigation 2, and autonomous patrolling.

PlanningRobot Arm

Intermediate ⏱️ 15h

### StarAI Arm System Course

StarAI 6+1 DOF Manipulator: Kinematics, Dynamics, Imitation Learning & Advanced VLA-based Reinforcement Learning

Planning[Wheel-Legged Robot

Intermediate ⏱️ 8h

### Stackforce Wheeled-Legged Robots Course

Balance control and LQR motion planning for hybrid robots.

Learning](https://github.com/Seeed-Projects/AI_Robotics_Academy/blob/main/Seeed_Mini_Wheeled_Legged_Robot/English/README.md)[Desktop Robot

Advanced ⏱️ 8h

### ReachyMini Tutorial 13 Lectures

Systematic Course on Basic Operation, Interface Tutorials and Secondary Development of ReachyMini

Learning](https://github.com/Seeed-Projects/AI_Robotics_Academy/blob/main/Seeed_ReachyMini_Tutorial/2.English/README.md)
