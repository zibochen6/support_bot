...
![](https://files.seeedstudio.com/wiki/Jetson-Mate/banner-2.png)
...
|  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Spec --|  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | | Power 65w PD|  |  |  |  | | --- | --- | --- | --- | | Dimensions 110mm x 110mm|  |  | | --- | --- | | Onboard Switch Microchip KSZ9896CTXC | | | | | | | |

## Hardware Overview

![](https://files.seeedstudio.com/wiki/Jetson-Mate/JetsonMate.png)

![](https://files.seeedstudio.com/wiki/Jetson-Mate/JetsonMate-2.png)
...
![pir](https://files.seeedstudio.com/wiki/Jetson-Mate/h-3.jpg)

* **Step 2.** Connect a **micro-USB** cable from Jetson Mate to PC

![pir](https://files.seeedstudio.com/wiki/Jetson-Mate/micro-usb.jpg)

* **Step 3.** Connect a jumper between **BOOT and GND pins** for **recovery mode**

![pir](https://files.seeedstudio.com/wiki/Jetson-Mate/jumper.jpg)
...
![pir](https://files.seeedstudio.com/wiki/Jetson-Mate/1.png)
...
![pir](https://files.seeedstudio.com/wiki/Jetson-Mate/SDK-Manager.png)
...
![pir](https://files.seeedstudio.com/wiki/Jetson-Mate/2.png)

* **Step 5.** Select the connected module
* **Step 6.** On the configuration window, **uncheck** Host Machine.

![pir](https://files.seeedstudio.com/wiki/Jetson-Mate/3.png)
...
![pir](https://files.seeedstudio.com/wiki/Jetson-Mate/5.png)
...
![pir](https://files.seeedstudio.com/wiki/Jetson-Mate/6.png)

* **Step 11.** Start downloading and flashing

![pir](https://files.seeedstudio.com/wiki/Jetson-Mate/7.png)

* **Step 12.** After downloading and flashing the OS is finished, you will see the following output

![pir](https://files.seeedstudio.com/wiki/Jetson-Mate/8.png)
...
![pir](https://files.seeedstudio.com/wiki/Jetson-Mate/grep_tty.png)
...
![pir](https://files.seeedstudio.com/wiki/Jetson-Mate/initial-config-minicom.png)
...
![pir](https://files.seeedstudio.com/wiki/Jetson-Mate/9.png)
...
![](https://files.seeedstudio.com/wiki/Jetson-Mate/Picture1.png)
...
![](https://files.seeedstudio.com/wiki/Jetson-Mate/Picture2.png)
...
![](https://files.seeedstudio.com/wiki/Jetson-Mate/Picture3.png)
...
![](https://files.seeedstudio.com/wiki/Jetson-Mate/Picture4.png)
