...
If you encounter GLIBCXX\_3.4.30 symbol errors:

![](https://files.seeedstudio.com/wiki/reComputer-Jetson/v_engine/erro1.png)

The libstdc++.so.6 file in the conda environment is outdated and does not have the symbol GLIBCXX\_3.4.30. However, the TensorRT dynamic library /usr/lib/aarch64-linux-gnu/libnvinfer.so.10 in the system requires this symbol!
...
**Expected Output:** Should display vp\_engine package information
